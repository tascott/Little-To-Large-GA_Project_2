...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { cost: @subcategory.cost, description: @subcategory.description, event_id: @subcategory.event_id, name: @subcategory.name, paid: @subcategory.paid, user_id: @subcategory.user_id }
    end
  ...
  test "should update subcategory" do
    patch :update, id: @subcategory, subcategory: { cost: @subcategory.cost, description: @subcategory.description, event_id: @subcategory.event_id, name: @subcategory.name, paid: @subcategory.paid, user_id: @subcategory.user_id }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
