...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { body: @subcategory.body, event_id: @subcategory.event_id, event_id: @subcategory.event_id, name: @subcategory.name }
    end
  ...
  test "should update subcategory" do
    patch :update, id: @subcategory, subcategory: { body: @subcategory.body, event_id: @subcategory.event_id, event_id: @subcategory.event_id, name: @subcategory.name }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
